...
if __name__ == "__main__":
    ...
    phi = 2
    Cuda = True
    annotation_path = './data/identify_violence/train.txt'
    classes_path = './data/tmp.names'
    # -------------------------------#
    #   Dataloder的使用
    # -------------------------------#
    ...
    model_path = "pretrain_weights/efficientdet-d2.pth"
    # 加快模型训练的效率
    ...
    if True:
        ...
        for epoch in range(Freeze_Epoch, Unfreeze_Epoch):
            val_loss = fit_one_epoch(net, efficient_loss, epoch, epoch_size, epoch_size_val, gen, gen_val,
                                     Unfreeze_Epoch, Cuda)
            lr_scheduler.step(val_loss)
